...
import { fetchBusinessDetails, fetchBusinessReviews, addBusinessReviews } from '../../actions/businessActions'
...
this.fetchBusinessDetails(id)
 ...
 fetchBusinessDetails = (id) => {
  ...
  console.log(id)
  this.props.dispatch(fetchBusinessDetails(id))
  .then(() => {
    this.props.dispatch(fetchBusinessReviews(id))
    .then(() => {
      this.setState({
        isLoading: false,
        isError: false
...
addBusinessReviews = () => {
  ...
  const  id  = this.props.match.params.businessId;
  console.log(id)
  this.props.dispatch(addBusinessReviews(id, this.state))
  .then(() => {
    alert('success')
  })
  .catch(error => {
